      ...
      <div id="car_list_in_container${car.no}" onload="test(${car.no})" onmouseover="zoom('${car.no}')"style="float:left; width:90%; cursor:pointer; border: 0px solid #747474; border-radius:6px; margin: 0% 0% 10% 10%; box-shadow: -2px 2px 5px 2px #747474;">
            <div id="car_list_title_box" >
               ...
               <input type="file" name="img" style="width:350px; margin-left:15%;">
                  <input type="submit" value="수정" formaction="/pieca/car/updateForm" style="background-color:#F15F5F; border:#F15F5F; color:#FFFFFF; margin-left:35%;">
                  <input type="submit" value="삭제" formaction="/pieca/car/delete"style="background-color:#F15F5F; border:#F15F5F; color:#FFFFFF;">
               </div>
            ...
            <div id ="car_list_description"  style="width:100%; height:230px;">
               ...
               <div id="car_list_fuel_sub" style="float:left; font-size:15px; height:45px; margin: 0% 0% 3% 0%;  color:#747474">
                     <p>도심 : <form:input path="dt_min_fuel" value="${car.dt_min_fuel} " style="width:110px;"/> ~ <form:input path="dt_max_fuel" value="${car.dt_max_fuel}" style="width:110px; margin:0px 0px 10px 0px"/>km/kWh</p>
